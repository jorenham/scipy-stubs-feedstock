...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/scipy-stubs-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/scipy-stubs-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add scipy-stubs scipy-typed
# for installing globally
pixi global install scipy-stubs scipy-typed
```
...
It is possible to list all of the versions of `scipy-stubs` available on your platform:
...
```
pixi search scipy-stubs --channel conda-forge
```
